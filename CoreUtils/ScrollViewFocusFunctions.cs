...
public static class ScrollViewFocusFunctions
{
	...
	public static Vector2 CalculateFocusedScrollPosition( this ScrollRect scrollView, RectTransform item , Vector2 offset = default(Vector2))
	{
	...
	public static void FocusOnItemTween( this ScrollRect scrollView, RectTransform item, float duration )
	{
		Vector2 targetPos = scrollView.CalculateFocusedScrollPosition(item);
	}
}