...
namespace Core.Editor
{
    public class NodeGraphEditorWindow : EditorWindow, ISearchWindowProvider
    {
        ...
        public void CreateGUI()
        {
            ...
            var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Plugins/actor-core/GameplayAbilitySystem/NodeGraph/NodeGraphEditorWindowX.uxml");
            visualTree.CloneTree(root);
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Plugins/actor-core/GameplayAbilitySystem/NodeGraph/NodeGraphEditorWindow.uss");
