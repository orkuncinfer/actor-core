...
namespace Core.Editor
{
    public class NodeView : Node
    {
        ...
        public void OnCreated()
        {
            ...
            var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Plugins/actor-core/GameplayAbilitySystem/NodeGraph/NodeGraphEditorWindow.uss"); // Replace with the actual path
