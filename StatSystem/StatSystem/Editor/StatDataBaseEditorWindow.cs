...
public class StatDataBaseEditorWindow : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        var visualTree = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>("Assets/Plugins/actor-core/StatSystem/StatSystem/Editor/StatDataBaseEditorWindow.uxml");
        visualTree.CloneTree(root);
        var styleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>("Assets/Plugins/actor-core/StatSystem/StatSystem/Editor/StatDataBaseEditorWindow.uss");
